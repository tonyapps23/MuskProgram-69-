package com.tony_fire.xteslaprogram
...
import com.tony_fire.xteslaprogram.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.ttgew.setOnClickListener {
            ...
            binding.ttgew.setBackgroundResource(R.drawable.bg_color_select)
            binding.ttgew.isEnabled = false

            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f4d230a3d18cbe61980ae3a",ed2stName,ed_tel,"rterfvgrtu")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.ttgew.setBackgroundResource(R.drawable.bg_selector)
                                binding.ttgew.isEnabled = true
                            }
